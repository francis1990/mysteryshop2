    ...
    <div class="card card-info">
        ...
        <div class="card-header">
            <h4 class="card-title font-weight-bold">Establishment types
                <span v-show="establishment_types.total"
                      class="right badge badge-dark">{{ establishment_types.total }}</span>
            </h4>
        </div>
        <div class="card-body">
            ...
            <div class="pt-2">
                <div v-if="establishment_types.data.length || !loaded" class="table-responsive">
                    ...
                    <pagination :limit="5" :data="establishment_types"
                                @pagination-change-page="getEstablishmentTypes"></pagination>
                </div>
                <div v-else class="alert alert-warning text-center">
                    No hay ningún elemento para mostrar
                </div>
            </div>
            <establishment-types-form-component @loadData="getEstablishmentTypes(1)"
                                                ref="formEstablishmentType"></establishment-types-form-component>
...
<script>
    ...
    export default {
        components: {
            EstablishmentTypesFormComponent,
            EstablishmentTypeDetailsComponent,
            EstablishmentTypeItemComponent
        },
        mounted() {
