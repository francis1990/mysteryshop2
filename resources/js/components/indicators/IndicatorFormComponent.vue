<template>
    <div class="modal fade" id="modalFormIndicator">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a v-if="action==='update'" @click="updateIndicator" class="btn btn-primary">Guardar</a>
                    <a v-else @click="createIndicator" class="btn btn-primary">Guardar</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
    ...
    export default {
        ...
        methods: {
            showForm(action, indicator = null) {
                ...
                $('#modalFormIndicator').modal({backdrop: 'static', keyboard: false,'show':true})
            },
            createIndicator() {
                let url = `cmsapi/indicators`;
            ...
            updateIndicator() {
                let url = `cmsapi/indicators/${this.form.id}`;
